...
var StyleRule = function(_BaseStyleRule) {
  ...
  function StyleRule2(key, style, options) {
    ...
    var selector = options.selector, scoped = options.scoped, sheet = options.sheet, generateId3 = options.generateId;
    if (selector) {
      _this.selectorText = selector;
    } else if (scoped !== false) {
      _this.id = generateId3(_assertThisInitialized2(_assertThisInitialized2(_this)), sheet);
...
var KeyframesRule = function() {
  function KeyframesRule2(key, frames, options) {
    ...
    this.options = options;
    var scoped = options.scoped, sheet = options.sheet, generateId3 = options.generateId;
    this.id = scoped === false ? this.name : escape(generateId3(this, sheet));
    this.rules = new RuleList(_extends({}, options, {
      parent: this
    }));
...
var RuleList = function() {
  ...
  _proto.add = function add(name, decl, ruleOptions) {
    var _this$options = this.options, parent = _this$options.parent, sheet = _this$options.sheet, jss = _this$options.jss, Renderer = _this$options.Renderer, generateId3 = _this$options.generateId, scoped = _this$options.scoped;
...
var createGenerateId = function createGenerateId2(options) {
  ...
  var ruleCounter = 0;
  var generateId3 = function generateId4(rule, sheet) {
    ruleCounter += 1;
...
var Step = function Step2(_ref) {
  ...
  return (0, import_react3.createElement)(StepContext.Provider, {
    value: contextValue
  }, index4 !== 0 && (hideConnectors === "inactive" && (active || completed) || hideConnectors !== true && hideConnectors !== "inactive") && (0, import_react3.createElement)(Connector2, null), (0, import_react3.createElement)("div", {
...
var generateId = function generateId2(rule) {
  return "RFS-" + rule.key;
};
var createGenerateId3 = function createGenerateId4() {
  return generateId;
};
defaultJss2.setup({
  createGenerateId: createGenerateId3
});
var Stepper = function Stepper2(_ref) {
  ...
  var stepsToRender = stepsArray.map(function(step, index4) {
    ...
    }, import_react3.default.isValidElement(step) ? import_react3.default.cloneElement(step, _extends3({}, stepProps, step.props)) : import_react3.default.createElement(Step, Object.assign({}, stepProps, step)));
  });
